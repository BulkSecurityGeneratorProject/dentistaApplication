...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.PersonAddress.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Appointment.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.AppointmentItem.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Procedure.class.getName(), jcacheConfiguration);
