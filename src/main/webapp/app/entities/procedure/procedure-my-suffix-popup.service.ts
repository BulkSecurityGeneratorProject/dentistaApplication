...
@Injectable()
export class ProcedureMySuffixPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.procedureModalRef(component, new ProcedureMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    procedureModalRef(component: Component, procedure: ProcedureMySuffix): NgbModalRef {
