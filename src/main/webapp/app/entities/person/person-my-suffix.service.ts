...
export class PersonMySuffixService {
    ...
    create(person: PersonMySuffix): Observable<PersonMySuffix> {
    ...
    update(person: PersonMySuffix): Observable<PersonMySuffix> {
        const copy = this.convert(person);
    ...
    find(id: number): Observable<PersonMySuffix> {
    ...
    private convert(person: PersonMySuffix): PersonMySuffix {
        const copy: PersonMySuffix = Object.assign({}, person);
