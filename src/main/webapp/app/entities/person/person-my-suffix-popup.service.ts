...
@Injectable()
export class PersonMySuffixPopupService {
        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.personService.find(id).subscribe((person) => {
                    person.hireDate = this.datePipe
                        .transform(person.hireDate, 'yyyy-MM-ddTHH:mm:ss');
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.personModalRef(component, new PersonMySuffix());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    personModalRef(component: Component, person: PersonMySuffix): NgbModalRef {
