...
@Component({
    selector: 'jhi-anamnesis-my-suffix',
    templateUrl: './anamnesis-my-suffix.component.html'
})
export class AnamnesisMySuffixComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/anamnesis-my-suffix'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.router.navigate(['/anamnesis-my-suffix', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: AnamnesisMySuffix) {
        return item.id;
    }
